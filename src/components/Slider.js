const Slider = {
    render: (min, max) => {
        return `
            ...
            Price 
               <span>
                    <strong> From: </strong>
                    <input id="min-price" type="number" value="${min}" min="${min}" max="${max}" step="0.1"> 
                    <strong> To: </strong>
                    <input id="max-price" type="number" value="${max}" min="${min}" max="${max}" step="0.1">  $
                </span>
    ...
    after_render: () => {
        ...
        const values = slider.querySelectorAll('input[type="number"]');
        ranges.forEach(el => {
            el.oninput = () => {
